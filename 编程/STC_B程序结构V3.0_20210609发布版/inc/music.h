...
函数参数：
      beatsPM：节拍率，即每分钟节拍数，值范围10~255拍/分钟，如果参数值为“invalid”将不改变原beatsPM；
			tone：指定音调， 有效值：0xFA、0xFB、0xFC、0xFD、0xFE、0xFF、0xF9分别对应音乐A、B、C、D、E、F、G调，参数值为“invalid”或其它值将不改变原tone
			*pt ：指向要播放的音乐编码的首地址
...
enum MusicKeyword {enumMscNull=0xF0,enumMscDrvSeg7,enumMscDrvLed,enumMscDrvSeg7andLed,enumMscSetBeatsPM,enumMscSetTone,enumMscRepeatBegin,enumMscRepeatEnd};
